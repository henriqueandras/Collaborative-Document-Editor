// This file contains a custom-made Rooms class that we can use to organize sockets among documents
// The purpose is to send updates to the correct clients only
class Rooms {
  constructor() {
    this.rooms = {};
    this.proxy_sid = null;
