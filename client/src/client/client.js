...
AwaitingWithBuffer.prototype.applyFromServer = function(client, delta) {
  ...
  //
  // * pair1[1]
    const del = new Delta(delta);
	var newOutstanding = del.transform(this.outstanding, false);
	var newBuffer = del.transform(this.buffer, false)
	var toApply = newOutstanding.transform(del, false)
